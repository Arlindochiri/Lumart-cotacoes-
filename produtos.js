...
function termosPagamentoTexto(carrinho) {
  ...
  if (temDisponivel && temSobEnc) {
    return [
      tFn ? tFn("checkout.termos_em_stock") : "Produtos em stock: 60% no pedido + 40% na entrega",
  ...
  return [tFn ? tFn("checkout.termos_so_stock") : "60% no momento do pedido + 40% na entrega"];
}
