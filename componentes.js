...
(function pwaInit() {
  ...
  window.addEventListener("appinstalled", () => {
    ...
    if (typeof mostrarToast === "function") {
      mostrarToast("Lumart instalada com sucesso!");
    }
  });
  ...
  function mostrarBannerPWA() {
    ...
    banner.innerHTML = `
      ...
      <div class="pwa-banner-texto">
        <strong>Instalar a Lumart</strong>
        <p>Acesso rápido às suas cotações, mesmo offline. Sem ocupar muito espaço.</p>
      </div>
      <div class="pwa-banner-acoes">
        <button class="pwa-btn-secundario" id="pwa-btn-dispensar" aria-label="Agora não">
          Agora não
        </button>
