...
const TRADUCOES = {
  pt: {
    ...
    "produto.disp_termos": "Pagamento: 100% no momento do pedido",
    ...
    "carrinho.termos": "Preços em MZN · Em stock: 100% no pedido · Sob encomenda: 75%/25%",
    ...
    "checkout.bloco_dados_sub": "Informação para contacto",
    "checkout.bloco_entrega": "Endereço de Entrega",
    "checkout.bloco_entrega_sub": "Onde quer receber o pedido",
    ...
    "checkout.termos_em_stock": "Produtos em stock: 100% no pedido",
    "checkout.termos_sob_enc": "Produtos sob encomenda: 75% no pedido + 25% na entrega",
    "checkout.termos_so_stock": "100% no momento do pedido",
    ...
    "wpp.total_a_pagar": "Total a pagar agora:",
  ...
  en: {
    ...
    "produto.disp_termos": "Payment: 100% at order time",
    ...
    "carrinho.termos": "Prices in MZN · In stock: 100% at order · Pre-order: 75%/25%",
    ...
    "checkout.bloco_dados_sub": "Contact information",
    "checkout.bloco_entrega": "Delivery Address",
    "checkout.bloco_entrega_sub": "Where to deliver your order",
    ...
    "checkout.termos_em_stock": "In-stock products: 100% at order",
    "checkout.termos_sob_enc": "Pre-order products: 75% at order + 25% on delivery",
    "checkout.termos_so_stock": "100% at order",
    ...
    "wpp.total_a_pagar": "Total to pay now:",
